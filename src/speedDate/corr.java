...
public class corr {
	...
	public static int dist2partner(double[][] partner, double[][] sample, int x, int k) {
		...
		for (int i = 0; i < partner.length; i++) {
			...
			dist += Math.abs(query[Date.valueOf("age").ordinal()] - partner[i][Date.valueOf("age_o").ordinal()])
					+ Math.abs(query[Date.valueOf("attr1_1").ordinal()] - partner[i][Date.valueOf("attr3_1").ordinal()])
					+ Math.abs(query[Date.valueOf("sinc1_1").ordinal()] - partner[i][Date.valueOf("sinc3_1").ordinal()])
					+ Math.abs(
							query[Date.valueOf("intel1_1").ordinal()] - partner[i][Date.valueOf("intel3_1").ordinal()])
					+ Math.abs(query[Date.valueOf("fun1_1").ordinal()] - partner[i][Date.valueOf("fun3_1").ordinal()])
					+ Math.abs(query[Date.valueOf("amb1_1").ordinal()] - partner[i][Date.valueOf("amb3_1").ordinal()])
					+ Math.abs(query[Date.valueOf("attr3_1").ordinal()] - partner[i][Date.valueOf("attr1_1").ordinal()])
					+ Math.abs(query[Date.valueOf("sinc3_1").ordinal()] - partner[i][Date.valueOf("sinc1_1").ordinal()])
					+ Math.abs(
							query[Date.valueOf("intel3_1").ordinal()] - partner[i][Date.valueOf("intel1_1").ordinal()])
					+ Math.abs(query[Date.valueOf("fun3_1").ordinal()] - partner[i][Date.valueOf("fun1_1").ordinal()])
					+ Math.abs(query[Date.valueOf("amb3_1").ordinal()] - partner[i][Date.valueOf("amb1_1").ordinal()]);
